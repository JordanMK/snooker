...
export const getKlassementSpeeldag = (id) => get(`/speeldagen/${id}/klassement`)

export const getKlassementSeizoen = (seasonId) => get(`/seizoenen/${seasonId}/klassement`)

export const getUser = (id) => get(`/users/${id}`)

export const getAllUsers = () => get("/users")

export const updateUserBetaald = (userId, betaald) => patch(`/users/${userId}`, { betaald })

export const postSpeeldagJokerAndSchiftingsAntwoord = (jokerGebruikt, schiftingsAntwoord, speeldagId) => {
  const data = {
...
export const patchWedstrijd = async (date, thuis, uit, resultaat, wedstrijdId, seizoenId) => {
  const data = { datum: date, resultaat, thuis, uit }

  // cannot run those in parallel
  try {
...
export const updateSpeeldagKlassement = (speeldagId) => post(`/speeldagen/${speeldagId}/klassement`)

export const patchSpeeldag = async (schiftingsvraag, schiftingsantwoord, startDatum, eindDatum, speeldagId) => {
  const data = {
...
export const beeindigSeizoen = (seasonId) => patch(`/seizoenen/${seasonId}`, { seizoenBeendigd: true })

export const postSpeeldag = (schiftingsvraag, schiftingsantwoord, startDatum, einddatum, seizoenId) => {
  const data = {
    schiftingsantwoord: Number(schiftingsantwoord),
    schiftingsvraag: schiftingsvraag,
    wedstrijden: [],
...
export const deleteWedstrijd = (wedstrijdId) => delete_(`/wedstrijden/${wedstrijdId}`)

export const patchSpeeldagVote = (obj, voteId) => patch(`/speeldagVotes/${voteId}`, { obj })
