...
export default function CreateSeason() {
	...
	const onSubmit = (event) => {
		...
		const aantalJokers = formData.get("aantalJokers");
		// FIXME: einddatum is not being passed
		const season = { name, startdatum, aantalJokers /*eindDatum*/ };

		// TODO: handle duplicate seasons (needs support from api)
		createSeizoen(season).then(router.back).catch(console.error);
	};
	...
	return (
		<>
            ...
            */}
						...
						/>
						<br />
						<label htmlFor="aantalJokers">Aantal Jokers:</label>
						<input
							type="number"
							name="aantalJokers"
							className="form-control"
